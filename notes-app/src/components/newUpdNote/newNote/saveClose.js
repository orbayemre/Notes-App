...
export default function SaveClose() {
    ...
    return(
        ...
        <button onClick={saveStore} className="flex justify-center items-center w-1/4 h-5 mt-5 py-3 border border-green-500 text-white bg-green-500 rounded-2xl shadow m-auto
        hover:bg-white hover:text-green-500
        dark:text-dark dark:hover:bg-dark dark:hover:text-green-500 duration-200">
            <span>Save</span>
        </button>
    
        <button onClick={closeComp} className="flex justify-center items-center w-1/4 h-5 mt-5 py-3 border border-red-500 text-white bg-red-500 rounded-2xl shadow m-auto
