...
export default function NewNote(){
    ...
    return(
        <>
            <div ref={close} id="updComp" className="z-30 w-2/5 h-96 bg-light shadow-type2  rounded fixed top-1/4 left-1/3">
                <Inputs/>
                <Colors/>
                <FontFav/>
                <SaveClose/>
            ...
            <div id="blur" className="z-20 w-full h-full backdrop-blur-sm top-0 left-0"></div>
        </>
    )
}