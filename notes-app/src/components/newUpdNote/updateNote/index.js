...
export default function NewNote(){
    ...
    return(
        <>
            <div ref={close} id="updComp" className="z-30 w-2/5 xl:w-2/5 xl:left-1/3 lg:w-2/4 lg:left-60 md:w-4/5 md:left-20 phone:w-full h-96 bg-light shadow-type2  rounded fixed top-1/4
